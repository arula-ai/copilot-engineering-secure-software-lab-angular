# Lab 2: Threat Modeling with GitHub Copilot
...
- Authentication Controller (login, registration, password reset)
- Payment Handler (process payments, refunds, webhooks)
- Resource Controller (file access, external fetching)
...
**Copilot Chat Prompt:**
```
Generate a Mermaid flowchart diagram for a payment system with:
...
**Copilot Chat Prompt:**
```
For the auth/payment system, identify:
...
**Copilot Chat Prompt:**
```
Perform STRIDE analysis for the auth/payment system.
...
**Copilot Chat Prompt:**
```
Based on the STRIDE analysis for the auth/payment system,
...
**Copilot Chat Prompt:**
```
Create a threat model document for the auth/payment system.
